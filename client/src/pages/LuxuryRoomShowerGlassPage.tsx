...
const GALLERY_IMAGES = [
  {
    src: "/images/Luxury-Room-with-Partition-Glass-Room.jpg",
    title: "Luxury Room with Glass Partition",
    caption: "300 sq. ft. modern room featuring king bed, sleek vanity, and designer glass shower cubicle"
  },
  {
    src: "/images/luxury-room-1-room-home-left.jpg",
    title: "Dressing Vanity & Workstation",
    caption: "Dedicated dressing table with drawers, full mirror, and spacious almirah"
  },
  {
    src: "/images/luxury-room-1-room-home-right.jpg",
    title: "Lawn Garden Window & Seating",
    caption: "Sunlit garden-facing windows and comfortable lounge seating"
  },
  {
    src: "/images/room_luxury.jpg",
    title: "Contemporary Room Interior",
    caption: "Warm earthy tones with modern glass architecture and plush bedding"
  }
];
...
const PACKAGES = [
  {
    ...
    rate: "₹6,000",
    desc: "Includes 1 Night Stay + Lavish 100% Pure Veg Buffet Breakfast for 2 adults",
    badge: "Most Popular"
  },
  {
    id: "map",
...
const OTHER_ROOMS = [
  ...
  },
  {
    ...
    link: "/luxury-room-2",
    desc: "Warm earthy tones with wood paneling, dressing table with drawers, and lawn sit-out."
  }
];

export default function LuxuryRoomShowerGlassPage() {
  const [, setLocation] = useLocation();
  const [selectedGalleryIdx, setSelectedGalleryIdx] = useState(0);
  const [selectedPackage, setSelectedPackage] = useState(PACKAGES[0]);
  const [isBookingOpen, setIsBookingOpen] = useState(false);
  const [bookingIntent, setBookingIntent] = useState("Luxury Room (Shower Glass Partition) Booking (₹6,000/night)");

  const openBooking = (intent = "Luxury Room with Shower Glass Partition") => {
    ...
    <div className="min-h-screen bg-[#FFFDF9] text-[#0E295B] font-sans">
      ...
      <div className="pt-28 pb-4 bg-[#061A33] text-white/70 border-b border-white/10">
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12 flex items-center gap-2 text-xs font-semibold">
          ...
          <ChevronRight size={13} className="opacity-40" />
          <span className="text-[#FFA96B] font-bold">Luxury Room with Shower Glass Partition</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#F68734]/20 via-[#01A5E1]/20 to-transparent border border-[#FFA96B]/35 text-[#FFA96B] text-xs font-black uppercase tracking-widest self-start backdrop-blur-md shadow-[0_0_20px_rgba(246,135,52,0.15)]">
                ...
                <span>🚿 SHOWER GLASS PARTITION &bull; 300 SQ. FT. &bull; ₹6,000/NIGHT</span>
              </div>

              <h1 className="text-3xl sm:text-5xl lg:text-[50px] font-black text-white font-display tracking-tight leading-[1.12]">
                Luxury Room with <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFA96B] via-[#FFE2B3] to-[#89D9F8]">Shower Glass Partition</span>
              </h1>
              ...
              <p className="text-white/80 text-sm sm:text-base leading-relaxed max-w-2xl font-normal border-l-2 border-[#01A5E1]/50 pl-4 py-0.5">
                The Luxury rooms offer spacious 300 sq. ft. accommodations furnished with warm shades of earthy colors, designed for comfort. Highlights include a contemporary attached bathroom with a sleek shower glass partition, king-size bed, dressing table, almirah, and garden view.
              </p>

              {/* Spec Cards */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                {[
                  { label: "Dimensions", value: "20 x 15 Sq. Ft.", color: "#89D9F8", Icon: Maximize2 },
                  { label: "Bath Type", value: "Glass Partition", color: "#FFA96B", Icon: Bath },
                  { label: "Capacity", value: "2 Adults", color: "#89D9F8", Icon: Users },
                  { label: "Balcony View", value: "Garden Lawns", color: "#69B32D", Icon: Sun },
              ...
              <div className="flex flex-wrap items-center gap-4 pt-1">
                <button
                  type="button"
                  onClick={() => openBooking(`Luxury Room (Shower Glass) - ${selectedPackage.name} (${selectedPackage.rate})`)}
                ...
                <a
                  href="https://www.aapnoghar.com/aapno360/luxury-room.html"
                  target="_blank"
              ...
              <div className="flex flex-wrap items-center gap-5 text-xs font-semibold text-white/60 pt-1">
                ...
                <span className="flex items-center gap-1.5"><CheckCircle2 size={13} className="text-[#69B32D]" /> 2-4 Device Wi-Fi</span>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white/20 aspect-[4/3] bg-black/40 group">
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = "/images/room_luxury.jpg";
                  }}
      ...
      <section className="py-16 bg-[#FDFCF9] border-b border-[#0E295B]/10">
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-[#0E295B] font-display mt-1">Choose Your Stay Package</h2>
          </div>
            ...
            {PACKAGES.map((pkg) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={(e) => { e.stopPropagation(); setSelectedPackage(pkg); openBooking(`Luxury Room (Glass Partition) - ${pkg.name} (${pkg.rate})`); }}
        ...
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-8 space-y-10">
              <div>
                <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#01A5E1]/10 border border-[#01A5E1]/25 text-[#01A5E1] text-xs font-black uppercase tracking-wider mb-3">
                  <Sparkles size={14} /><span>Modern Bath Architecture &bull; 300 Sq. Ft.</span>
                </div>
                <h2 className="text-2xl sm:text-4xl font-black text-[#0E295B] font-display tracking-tight leading-tight">
                  Contemporary glass partition bath paired with earthy resort calm.
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="p-6 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#01A5E1]/30 hover:shadow-md transition-all flex flex-col justify-between group">
                  ...
                  <div>
                    <h3 className="text-base font-black text-[#0E295B] font-display mb-2">Modern Shower Glass Partition</h3>
                    <p className="text-xs sm:text-sm text-[#50657D] leading-relaxed">
                      Features a sleek glass shower enclosure that keeps dry and wet zones separated, complete with 24-hour hot &amp; cold water and organic bath amenities.
                    </p>
                  </div>
                </div>
                <div className="p-6 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#F68734]/30 hover:shadow-md transition-all flex flex-col justify-between group">
                  ...
                  <div>
                    <h3 className="text-base font-black text-[#0E295B] font-display mb-2">20 x 15 Earthy Layout with Vanity</h3>
                    <p className="text-xs sm:text-sm text-[#50657D] leading-relaxed">
                      Spacious 300 sq. ft. room with king bed, separate chair seating, dressing table with drawers, full mirror, and large storage almirah.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-6 pb-3 border-b border-[#0E295B]/10">
                  <h3 className="text-xl font-black text-[#0E295B] font-display flex items-center gap-2.5">
                    <Star size={20} className="text-[#F68734]" /><span>Complete Room Amenities</span>
                  </h3>
                  <span className="text-xs font-bold text-[#50657D] uppercase tracking-wider">22 Luxury Features</span>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  {[
                    {
                      title: "Bedroom & Storage", color: "#F68734", Icon: BedDouble,
                      items: [
                        "King Size Bed (20x15 Sq. Ft. Room)",
                        "Dressing Table with Drawers & Mirror",
                        "Almirah with Plentiful Hanging Space",
                        "Separate Chair Seating & Coffee Table",
                        "Wardrobe & Cotton Room Slippers"
                      ]
                    },
                    {
                      title: "Bath & Wellness", color: "#01A5E1", Icon: Bath,
                      items: [
                        "Attached Bath with Shower Glass Partition",
                        "24-Hr Hot & Cold Running Water",
                        "Complimentary Organic Toiletries Kit",
                        "Hair Dryer & Iron (On Request)",
                        "Fresh Plush Bath Linen"
                      ]
                    },
                    {
                    ...
                    },
                    {
                      ...
                      items: [
                        ...
                        "Dual Hot & Cold Air Conditioning",
                        "In-Room Digital Safe",
                        "Intercom & Wheelchair Access"
                      ]
                    }
            ...
            <div className="lg:col-span-4 bg-[#061A33] text-white rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/20 sticky top-28">
              ...
              <button
                type="button"
                onClick={() => openBooking(`Luxury Room (Shower Glass Partition) - ${selectedPackage.name} (${selectedPackage.rate})`)}
              ...
              >
                <span>Reserve Room Now</span><ArrowRight size={16} />
              </button>

              <a
                href={`https://wa.me/917666779997?text=${encodeURIComponent(`Hi AapnoGhar, I want to book Luxury Room with Shower Glass Partition (${selectedPackage.name} - ${selectedPackage.rate}).`)}`}
                target="_blank"
                rel="noopener noreferrer"
