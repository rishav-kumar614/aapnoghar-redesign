...
const GALLERY_IMAGES = [
  {
    src: "/images/room_presidential.jpg",
    title: "Master & Twin Attached Bedrooms",
    caption: "Spacious family suite offering two attached bedrooms with rich wood furnishings"
  },
  {
    src: "/images/presidential_suite.jpg",
    title: "Royal Living Lounge & Dining",
    caption: "Expansive group lounge seating with dining table and executive desk"
  },
  {
    src: "/images/presidential-suite-room-1-room-home-left.jpg",
    title: "Luxury Bathroom with Bathtub",
    caption: "Attached spacious bath with bathtub & 24-hr hot/cold water"
  },
  {
    src: "/images/presidential-suite-room-1-room-home-right.jpg",
    title: "Lawn-Facing Private Sit-Out",
    caption: "Direct balcony access overlooking manicured 9-acre resort grounds"
  }
];
...
const OTHER_ROOMS = [
  {
    id: "suite1",
    name: "Luxury Presidential Suite 1",
    rate: "Premium Luxury",
    size: "800 Sq. Ft.",
    image: "/images/presidential_suite.jpg",
    link: "/presidential-suite-room-1",
    desc: "Single-master grand presidential suite with expansive royal lounge and lawn balcony."
  },
  {
    id: "suite",
    name: "Suite Room",
...
export default function PresidentialSuite2Page() {
  const [, setLocation] = useLocation();
  const [selectedGalleryIdx, setSelectedGalleryIdx] = useState(0);
  const [isBookingOpen, setIsBookingOpen] = useState(false);
  const [bookingIntent, setBookingIntent] = useState("Presidential Suite Delhi NCR Booking");

  const openBooking = (intent = "Presidential Suite Delhi NCR Staycation") => {
    ...
    <div className="min-h-screen bg-[#FFFDF9] text-[#0E295B] font-sans">
      ...
      <div className="pt-28 pb-4 bg-[#061A33] text-white/70 border-b border-white/10">
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12 flex items-center gap-2 text-xs font-semibold">
          ...
          <ChevronRight size={13} className="opacity-40" />
          <span className="text-[#FFA96B] font-bold">Presidential Suite (Delhi NCR)</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#F68734]/20 via-[#01A5E1]/20 to-transparent border border-[#FFA96B]/35 text-[#FFA96B] text-xs font-black uppercase tracking-widest self-start backdrop-blur-md shadow-[0_0_20px_rgba(246,135,52,0.15)]">
                ...
                <span>👑 Two-Bedroom Family Suite &bull; 800 Sq. Ft.</span>
              </div>

              {/* Editorial Title */}
              <h1 className="text-3xl sm:text-5xl lg:text-[50px] font-black text-white font-display tracking-tight leading-[1.12]">
                Presidential Suite for <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFA96B] via-[#FFE2B3] to-[#89D9F8]">Staycation &amp; Daycation</span> in Delhi NCR
              </h1>
              ...
              <p className="text-white/80 text-sm sm:text-base leading-relaxed max-w-2xl font-normal border-l-2 border-[#01A5E1]/50 pl-4 py-0.5">
                Stay in absolute luxury with your extended family or group in our spacious 800 sq. ft. family presidential suite featuring two attached bedrooms, common bathtub bathroom, private royal living lounge, and lawn sit-out.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                ...
                <div className="p-3.5 rounded-2xl bg-white/[0.05] border border-white/[0.12] backdrop-blur-md flex flex-col justify-between hover:bg-white/[0.09] hover:border-[#01A5E1]/40 transition-all group">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-bold uppercase text-[#FFA96B] tracking-wider">Layout</span>
                    <DoorOpen size={13} className="text-[#FFA96B]/70 group-hover:scale-110 transition-transform" />
                  </div>
                  <span className="text-sm sm:text-base font-black text-white">2 Bedrooms</span>
                </div>

                <div className="p-3.5 rounded-2xl bg-white/[0.05] border border-white/[0.12] backdrop-blur-md flex flex-col justify-between hover:bg-white/[0.09] hover:border-[#01A5E1]/40 transition-all group">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-bold uppercase text-[#89D9F8] tracking-wider">Capacity</span>
                    <Users size={13} className="text-[#89D9F8]/70 group-hover:scale-110 transition-transform" />
                  </div>
                  <span className="text-sm sm:text-base font-black text-white">4–6 Guests</span>
                </div>
                ...
                <div className="p-3.5 rounded-2xl bg-white/[0.05] border border-white/[0.12] backdrop-blur-md flex flex-col justify-between hover:bg-white/[0.09] hover:border-[#01A5E1]/40 transition-all group">
                  ...
                  <span className="text-sm sm:text-base font-black text-white">Lawn Garden</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-1">
                <button
                  type="button"
                  onClick={() => openBooking("Presidential Suite Delhi NCR")}
            ...
            <div className="lg:col-span-8 space-y-10">
              ...
              <div>
                <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#F68734]/10 border border-[#F68734]/25 text-[#F68734] text-xs font-black uppercase tracking-wider mb-3">
                  ...
                  <span>Two-Bedroom Luxury &bull; 800 Sq. Ft.</span>
                </div>
                <h2 className="text-2xl sm:text-4xl font-black text-[#0E295B] font-display tracking-tight leading-tight">
                  Designed for extended family staycations with dual attached bedrooms.
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="p-6 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#F68734]/30 hover:shadow-md transition-all flex flex-col justify-between group">
                  ...
                  <div>
                    <h3 className="text-base font-black text-[#0E295B] font-display mb-2">
                      Dual Attached Bedroom Setup
                    </h3>
                    <p className="text-xs sm:text-sm text-[#50657D] leading-relaxed">
                      Two well-appointed bedrooms connected to a central living space with common luxury bathroom — giving both parents and kids their own peaceful personal zone.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#01A5E1]/30 hover:shadow-md transition-all flex flex-col justify-between group">
                  ...
                  <div>
                    <h3 className="text-base font-black text-[#0E295B] font-display mb-2">
                      Group Living &amp; Lawn Sit-Out
                    </h3>
                    <p className="text-xs sm:text-sm text-[#50657D] leading-relaxed">
                      Features a full personal lounge seating, dining table, and direct lawn views — creating a welcoming open-air ambiance for evening tea, ceremonies, and chit-chats.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-6 pb-3 border-b border-[#0E295B]/10">
                  <h3 className="text-xl font-black text-[#0E295B] font-display flex items-center gap-2.5">
                    ...
                    <span>Complete Suite Amenities &amp; Inclusions</span>
                  </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="p-5 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#F68734]/30 transition-all">
                    <div className="flex items-center gap-3 mb-4 pb-3 border-b border-[#0E295B]/5">
                      ...
                      <h4 className="font-extrabold text-sm text-[#0E295B]">Dual Bedrooms &amp; Living</h4>
                    </div>
                    <ul className="space-y-2 text-xs font-semibold text-[#50657D]">
                      <li className="flex items-center gap-2"><CheckCircle2 size={13} className="text-[#F68734] shrink-0" /> Master Bedroom with King Size Bed</li>
                      <li className="flex items-center gap-2"><CheckCircle2 size={13} className="text-[#F68734] shrink-0" /> Second Attached Bedroom with Plush Bedding</li>
                      <li className="flex items-center gap-2"><CheckCircle2 size={13} className="text-[#F68734] shrink-0" /> Central Living Room Lounge Seating</li>
                      ...
                      <li className="flex items-center gap-2"><CheckCircle2 size={13} className="text-[#F68734] shrink-0" /> Wardrobes in Both Rooms</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-5 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#01A5E1]/30 transition-all">
                    ...
                    <ul className="space-y-2 text-xs font-semibold text-[#50657D]">
                      <li className="flex items-center gap-2"><CheckCircle2 size={13} className="text-[#01A5E1] shrink-0" /> Attached Common Bath with Bathtub</li>
                      <li className="flex items-center gap-2"><CheckCircle2 size={13} className="text-[#01A5E1] shrink-0" /> 24-Hr Hot &amp; Cold Running Water</li>
                      <li className="flex items-center gap-2"><CheckCircle2 size={13} className="text-[#01A5E1] shrink-0" /> Organic Toiletries &amp; Slippers</li>
                      <li className="flex items-center gap-2"><CheckCircle2 size={13} className="text-[#01A5E1] shrink-0" /> Hair Dryer &amp; Iron (On Request)</li>
                      <li className="flex items-center gap-2"><CheckCircle2 size={13} className="text-[#01A5E1] shrink-0" /> Plush Cotton Towels</li>
                    </ul>
                  </div>
            ...
            <div className="lg:col-span-4 bg-[#061A33] text-white rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/20 sticky top-28">
              <div className="flex items-center justify-between pb-4 mb-4 border-b border-white/15">
                <div>
                  ...
                  <div className="text-2xl font-black text-[#FFA96B] font-display">2-Bed Suite</div>
                </div>
              ...
              <a
                href="https://wa.me/917666779997?text=Hi%20AapnoGhar,%20I%20am%20interested%20in%20booking%20the%20Presidential%20Suite%20(Delhi%20NCR)."
                target="_blank"
                rel="noopener noreferrer"
