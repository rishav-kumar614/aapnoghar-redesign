...
const GALLERY_IMAGES = [
  {
    src: "/images/luxury-room-Room.jpg",
    title: "Luxury King Bedroom",
    caption: "300 sq. ft. warm-toned room with king-size bed and art-adorned interiors"
  },
  {
    src: "/images/luxury-room-room-home-left.jpg",
    title: "Separate Chair Seating & Work Desk",
    caption: "Comfortable lounge chair seating with executive desk for work-leisure balance"
  },
  {
    src: "/images/luxury-room-room-home-right.jpg",
    title: "Garden-View Window",
    caption: "Bright natural light streaming through windows overlooking lush resort lawns"
  },
  {
    src: "/images/room_suite.jpg",
    title: "Elegant Room Interior",
    caption: "Earthy warm color tones, premium bedding, and modern in-room comforts"
  }
];
...
const PACKAGES = [
  {
    ...
    rate: "₹6,000",
    desc: "Includes 1 Night Stay + Pure Veg Buffet Breakfast for 2 guests",
    badge: "Most Popular"
  },
  {
    id: "map",
  ...
  },
  {
    ...
    rate: "₹11,500",
    desc: "Includes Breakfast + Lunch + Dinner + Lawn Tea & Snacks",
    badge: "Full Board"
  },
  {
    id: "stay_play",
...
const OTHER_ROOMS = [
  {
    ...
    desc: "Grand royal suite with private living lounge, dining area, lawn balcony view and adjoining rooms."
  },
  {
    id: "suite",
    name: "Suite Room",
    ...
    link: "/suite-room",
    desc: "Spacious suite with king bed, sofa, dining table and big bathtub bathroom overlooking lawns."
  },
  {
    id: "deluxe",
    name: "Deluxe Room",
    ...
    link: "#",
    desc: "Cozy elegantly furnished room perfect for couples and weekend getaways near Delhi NCR."
  }
];

export default function LuxuryRoomPage() {
  const [, setLocation] = useLocation();
  const [selectedGalleryIdx, setSelectedGalleryIdx] = useState(0);
  const [selectedPackage, setSelectedPackage] = useState(PACKAGES[0]);
  const [isBookingOpen, setIsBookingOpen] = useState(false);
  const [bookingIntent, setBookingIntent] = useState("Luxury Room Booking (₹6,000/night)");

  const openBooking = (intent = "Luxury Room Booking") => {
    ...
    <div className="min-h-screen bg-[#FFFDF9] text-[#0E295B] font-sans">
      ...
      <div className="pt-28 pb-4 bg-[#061A33] text-white/70 border-b border-white/10">
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12 flex items-center gap-2 text-xs font-semibold">
          ...
          <ChevronRight size={13} className="opacity-40" />
          <span className="text-[#FFA96B] font-bold">Luxury Room</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#F68734]/20 via-[#01A5E1]/20 to-transparent border border-[#FFA96B]/35 text-[#FFA96B] text-xs font-black uppercase tracking-widest self-start backdrop-blur-md shadow-[0_0_20px_rgba(246,135,52,0.15)]">
                ...
                <span>🌿 300 SQ. FT. LUXURY ROOM &bull; STARTING ₹6,000/NIGHT</span>
              </div>

              <h1 className="text-3xl sm:text-5xl lg:text-[50px] font-black text-white font-display tracking-tight leading-[1.12]">
                Luxury Room in Gurgaon — <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFA96B] via-[#FFE2B3] to-[#89D9F8]">Warm Earthy Comfort</span> &amp; Garden Serenity
              </h1>
              ...
              <p className="text-white/80 text-sm sm:text-base leading-relaxed max-w-2xl font-normal border-l-2 border-[#01A5E1]/50 pl-4 py-0.5">
                The Luxury rooms offer spacious, warm-hued rooms furnished with earthy colors and designed for comfort. Each room features a king-size bed, separate lounge chair seating, executive desk, lush garden view, and an attached bathtub bathroom.
              </p>

              {/* Spec Cards */}
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                {[
                  { label: "Room Area", value: "300 Sq. Ft.", color: "#89D9F8", Icon: Maximize2 },
                  { label: "Bedding", value: "King Bed", color: "#FFA96B", Icon: BedDouble },
                  { label: "Occupancy", value: "2 Guests", color: "#89D9F8", Icon: Users },
                  { label: "View", value: "Garden View", color: "#69B32D", Icon: Sun },
              ...
              <div className="flex flex-wrap items-center gap-4 pt-1">
                <button
                  type="button"
                  onClick={() => openBooking(`Luxury Room - ${selectedPackage.name} (${selectedPackage.rate})`)}
      ...
      <section className="py-16 bg-[#FDFCF9] border-b border-[#0E295B]/10">
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-[#0E295B] font-display mt-1">Choose Your Luxury Room Package</h2>
          </div>
            ...
            {PACKAGES.map((pkg) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={(e) => { e.stopPropagation(); setSelectedPackage(pkg); openBooking(`Luxury Room - ${pkg.name} (${pkg.rate})`); }}
        ...
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-8 space-y-10">
              <div>
                <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#F68734]/10 border border-[#F68734]/25 text-[#F68734] text-xs font-black uppercase tracking-wider mb-3">
                  <Sparkles size={14} /><span>Earthy Luxury &bull; 300 Sq. Ft.</span>
                </div>
                <h2 className="text-2xl sm:text-4xl font-black text-[#0E295B] font-display tracking-tight leading-tight">
                  Warm earth tones, garden views &amp; premium comfort in every detail.
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="p-6 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#F68734]/30 hover:shadow-md transition-all flex flex-col justify-between group">
                  ...
                  <div>
                    <h3 className="text-base font-black text-[#0E295B] font-display mb-2">Earthy Warm Interiors</h3>
                    <p className="text-xs sm:text-sm text-[#50657D] leading-relaxed">
                      Thoughtfully designed with warm shades of earthy colors — natural wooden textures, art-adorned walls, and plush premium bedding for a cozy home-like feel.
                    </p>
                  </div>
                </div>
                <div className="p-6 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#01A5E1]/30 hover:shadow-md transition-all flex flex-col justify-between group">
                  ...
                  <div>
                    <h3 className="text-base font-black text-[#0E295B] font-display mb-2">Garden-View &amp; Private Sit-Out</h3>
                    <p className="text-xs sm:text-sm text-[#50657D] leading-relaxed">
                      Bright windowed rooms overlooking the resort's lush 9-acre greens, with sit-out chairs — perfect for morning tea with a serene nature backdrop.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  {[
                    {
                      ...
                      items: [
                        ...
                        "Executive Work Desk",
                        "Wardrobe & Room Slippers",
                        "Single Sofa-cum-Bed (on request)"
                      ]
                    },
                    {
                      ...
                      items: [
                        ...
                        "Complimentary Organic Toiletries",
                        "Hair Dryer & Iron (On Request)",
                        "Fresh Plush Cotton Towels"
                      ]
                    },
                    {
              ...
              <div className="p-6 rounded-3xl bg-gradient-to-br from-[#FCF3E9] to-[#FFFDF9] border border-[#F68734]/30">
                <h4 className="text-base font-black text-[#0E295B] mb-4 flex items-center gap-2">
                  ...
                  <span>Complimentary Resort Privileges</span>
                </h4>
            ...
            <div className="lg:col-span-4 bg-[#061A33] text-white rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/20 sticky top-28">
              ...
              >
                <span>Reserve Luxury Room</span><ArrowRight size={16} />
              </button>

              <a
                href={`https://wa.me/917666779997?text=${encodeURIComponent(`Hi AapnoGhar, I want to book Luxury Room (${selectedPackage.name} - ${selectedPackage.rate}).`)}`}
                target="_blank"
                rel="noopener noreferrer"
