...
const GALLERY_IMAGES = [
  {
    src: "/images/luxury-room-2-Room.jpg",
    title: "Luxury Room 2 King Suite",
    caption: "20 x 15 sq. ft. (300 sq. ft.) spacious bedroom with modern wood paneling and warm tones"
  },
  {
    src: "/images/luxury-room-2-room-home-left.jpg",
    title: "Dressing Vanity & Workstation",
    caption: "Dedicated dressing table with drawers, vanity mirror, and ample storage almirah"
  },
  {
    src: "/images/luxury-room-2-room-home-right.jpg",
    title: "Lawn Garden Window & Seating",
    caption: "Garden-view window bringing lush daylight alongside comfortable lounge seating"
  },
  {
    src: "/images/luxury-room-Room.jpg",
    title: "Cozy Evening Ambiance",
    caption: "Earthy warm color palette, plush king-size bed, and split hot & cold air conditioning"
  }
];
...
const PACKAGES = [
  {
    ...
    rate: "₹6,000",
    desc: "Includes 1 Night Stay + 100% Pure Veg Lavish Buffet Breakfast for 2 guests",
    badge: "Most Popular"
  },
  {
    id: "map",
...
const OTHER_ROOMS = [
  ...
  },
  {
    ...
    link: "/luxury-room",
    desc: "Spacious rooms furnished with warm earthy colors, king bed, and lawn sit-out."
  }
];

export default function LuxuryRoom2Page() {
  const [, setLocation] = useLocation();
  const [selectedGalleryIdx, setSelectedGalleryIdx] = useState(0);
  const [selectedPackage, setSelectedPackage] = useState(PACKAGES[0]);
  const [isBookingOpen, setIsBookingOpen] = useState(false);
  const [bookingIntent, setBookingIntent] = useState("Luxury Room 2 Booking (₹6,000/night)");

  const openBooking = (intent = "Luxury Room 2 Booking") => {
    ...
    <div className="min-h-screen bg-[#FFFDF9] text-[#0E295B] font-sans">
      ...
      <div className="pt-28 pb-4 bg-[#061A33] text-white/70 border-b border-white/10">
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12 flex items-center gap-2 text-xs font-semibold">
          ...
          <ChevronRight size={13} className="opacity-40" />
          <span className="text-[#FFA96B] font-bold">Luxury Room 2</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#F68734]/20 via-[#01A5E1]/20 to-transparent border border-[#FFA96B]/35 text-[#FFA96B] text-xs font-black uppercase tracking-widest self-start backdrop-blur-md shadow-[0_0_20px_rgba(246,135,52,0.15)]">
                ...
                <span>🌿 20 X 15 SQ. FT. (300 SQ. FT.) &bull; STARTING ₹6,000/NIGHT</span>
              </div>

              <h1 className="text-3xl sm:text-5xl lg:text-[50px] font-black text-white font-display tracking-tight leading-[1.12]">
                Luxury Room 2 in Gurgaon — <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFA96B] via-[#FFE2B3] to-[#89D9F8]">Warm Earthy Shades</span> &amp; Modern Comfort
              </h1>
              ...
              <p className="text-white/80 text-sm sm:text-base leading-relaxed max-w-2xl font-normal border-l-2 border-[#01A5E1]/50 pl-4 py-0.5">
                The Luxury Room 2 category offers 300 sq. ft. (20 x 15 sq. ft.) of comfortable living space furnished with warm shades of earthy colors. Features a king-size bed, separate lounge seating, dressing table with drawers, large almirah, attached bath with bathtub, and resort lawn view.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-1">
                <button
                  type="button"
                  onClick={() => openBooking(`Luxury Room 2 - ${selectedPackage.name} (${selectedPackage.rate})`)}
                ...
                <a
                  href="https://www.aapnoghar.com/aapno360/luxury-room-2.html"
                  target="_blank"
      ...
      <section className="py-16 bg-[#FDFCF9] border-b border-[#0E295B]/10">
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-[#0E295B] font-display mt-1">Choose Your Luxury Room 2 Package</h2>
          </div>
            ...
            {PACKAGES.map((pkg) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={(e) => { e.stopPropagation(); setSelectedPackage(pkg); openBooking(`Luxury Room 2 - ${pkg.name} (${pkg.rate})`); }}
        ...
        <div className="max-w-[1560px] mx-auto px-6 sm:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-8 space-y-10">
              <div>
                <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#F68734]/10 border border-[#F68734]/25 text-[#F68734] text-xs font-black uppercase tracking-wider mb-3">
                  <Sparkles size={14} /><span>20 x 15 Sq. Ft. &bull; 300 Sq. Ft.</span>
                </div>
                <h2 className="text-2xl sm:text-4xl font-black text-[#0E295B] font-display tracking-tight leading-tight">
                  Designed for relaxation with dedicated vanity dressing &amp; storage space.
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="p-6 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#F68734]/30 hover:shadow-md transition-all flex flex-col justify-between group">
                  ...
                  <div>
                    <h3 className="text-base font-black text-[#0E295B] font-display mb-2">20 x 15 Spacious Layout</h3>
                    <p className="text-xs sm:text-sm text-[#50657D] leading-relaxed">
                      Generous 300 sq. ft. room featuring rich warm wood paneling, comfortable king-size bed, separate coffee table lounge seating, and large windows.
                    </p>
                  </div>
                </div>
                <div className="p-6 rounded-3xl bg-[#FDFCF9] border border-[#0E295B]/10 hover:border-[#01A5E1]/30 hover:shadow-md transition-all flex flex-col justify-between group">
                  ...
                  <div>
                    <h3 className="text-base font-black text-[#0E295B] font-display mb-2">Dressing Vanity &amp; Storage Almirah</h3>
                    <p className="text-xs sm:text-sm text-[#50657D] leading-relaxed">
                      Equipped with a dedicated dressing table with drawers, full vanity mirror, and an almirah with plenty of hanging space for wedding and leisure attires.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-4 bg-[#061A33] text-white rounded-3xl p-6 sm:p-8 shadow-2xl border border-white/20 sticky top-28">
              ...
              >
                <span>Reserve Luxury Room 2</span><ArrowRight size={16} />
              </button>

              <a
                href={`https://wa.me/917666779997?text=${encodeURIComponent(`Hi AapnoGhar, I want to book Luxury Room 2 (${selectedPackage.name} - ${selectedPackage.rate}).`)}`}
                target="_blank"
                rel="noopener noreferrer"
